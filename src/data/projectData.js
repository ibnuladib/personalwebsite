export const projectData = {
    ...
    project2: {
      ...
      title: " CodeForces-Mail-to-Calender-script",
        tags: ["Python"],
      description: "Uses Gmail API to find events and Schedules them to Calender using Calender API",
    ...
    project4: {
      ...
      title: "ezNotes",
      tags: ["java"],
      description: "A simple note taking app similar to a sticky note on your screen",
    ...
    project6: {
      date: "2023",
      title: "ScreenShot Deleter",
      tags: ["java", "javafx"],
      description: "deletes screenshots from particular directory",
      githubLink: "https://github.com/ibnuladib/ScreenshotDeleter",
    },
    project7: {
      date: "2023",
      title: "Employee Management System",
      tags: ["java", "mySQL", "JSwing"],
